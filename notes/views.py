...
# def home(request):
#     return redirect('notes:newhome')

# def number_notes(request, num):
#     return redirect('notes:newnumber_notes', num=num)

# def sections(request):
#     return redirect('notes:newsections')

# def sub_sections(request, subsection):
#     return redirect('notes:newsub_sections', subsection=subsection)

# def web(request, query):
#     return redirect('notes:newweb', query=query)

# def redirect_view(request, id):
#     return redirect('notes:newredirect', id=id)
...
# def newsub_sections(request,subsection):
#     if subsection == 'web_frameworks':
#         return newweb_frameworks(request)
#     elif subsection == 'setting_up_django':
#         return newsetting_up_django(request)
#     elif subsection == 'url_mapping':
#         return newurl_mapping(request)


# def newweb_frameworks(request):
#     lst = [note['text'] for note in notes if note['section'] == 'Web Frameworks']
            
#     return HttpResponse(f"""
#                         <h3>Web frameworks blar</h3>
#                         <ol><li>{lst[0]}</li><li>{lst[1]}</li><li>{lst[2]}</li></ol>
#                         <a href='/sections/'>Back to sections</a>
#                         """)


# def newsetting_up_django(request):
#     lst = [note['text'] for note in notes if note['section'] == 'Setting up Django']
#     return HttpResponse(f"""
#                         <h3>Setting up Django blar</h3>
#                         <ol><li>{lst[0]}</li><li>{lst[1]}</li><li>{lst[2]}</li></ol>
#                         <a href='/sections/'>Back to sections</a>
#                         """)


# def newurl_mapping(request):
#     lst = [note['text'] for note in notes if note['section'] == 'URL Mapping']
    
#     return HttpResponse(f"""
#                         <h3>URL Mapping blar</h3>
#                         <ol><li>{lst[0]}</li><li>{lst[1]}</li><li>{lst[2]}</li></ol>
#                         <a href='/sections/'>Back to sections</a>
#                         """)


# def newweb(request, query):
#     lst = [note['text'] for note in notes if query in note['text'].lower()]
...
# def newnumber_notes(request, num):
#     n = len(notes)
#     for i in range(n):
#         if num == i + 1:
#             if num == 1:
...
#                         <h3>{notes[i]['section']}</h3>
#                         <p>{notes[i]['text']}</p>
#                         <a>Previous note</a> | <a href='/'>Back to home</a> | <a href='/{num+1}/'>Next note</a>
#                         """
#             elif num == n:
#                 result= f"""
#                         <h1>Note number {num}</h1>
#                         <h3>{notes[i]['section']}</h3>
#                         <p>{notes[i]['text']}</p>
#                         <a href='/{num-1}/'>Previous note</a> | <a href='/'>Back to home</a> | <a>Previous note</a>
#                         """
...
#                         <h3>{notes[i]['section']}</h3>
#                         <p>{notes[i]['text']}</p>
#                         <a href='/{num-1}/'>Previous note</a> | <a href='/'>Back to home</a> | <a href='/{num+1}/'>Next note</a>
#                         """
#             return HttpResponse(result)
